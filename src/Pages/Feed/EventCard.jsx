...
function EventCard(props) {
    ...
    async function attend(location) {
      ...
      async function updatePost(id) {
        ...
        const  currentUser = {"name":user.attributes['name'],"middle_name":user.attributes['middle_name'],"family_name":user.attributes['family_name'],"email":user.attributes['email']};
        var newAttendeeList = original.attendees
        newAttendeeList = [...newAttendeeList, currentUser];
        console.log(newAttendeeList)
    ...
    <>
      <Card class='p-20 w-1/2'>
        ...
        <Button type="button" onClick={()=>setModalVisible(true)
              ...
              <div>Time: {()=>Date(props.event['time'])}</div>
